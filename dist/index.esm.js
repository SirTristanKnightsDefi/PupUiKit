...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Pup Protector" },
            React.createElement("img", { src: "https://www.pupprotector.charity/wp-content/uploads/2023/03/msg5321545725-12202-1.jpg", alt: "PUP Logo", className: "mobile-icon" }),
            React.createElement("img", { src: banner, alt: "PUP Logo", className: "desktop-icon" }))) : (React.createElement(StyledLink, { to: href, "aria-label": "Pup Protector" },
            React.createElement("img", { src: "https://www.pupprotector.charity/wp-content/uploads/2023/03/msg5321545725-12202-1.jpg", alt: "PUP Logo", className: "mobile-icon" }),
            React.createElement("img", { src: banner, alt: "Pup Protector Logo", className: "desktop-icon" })))));
};
var templateObject_1$c;
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "http://twitter.com/PupProtector8",
    },
];
var MENU_HEIGHT = 64;
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, { href: "https://www.pupprotector.charity/", target: "_blank" },
            React.createElement("img", { src: "https://www.pupprotector.charity/wp-content/uploads/2023/03/msg5321545725-12202-1.jpg", alt: "PUP Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f1f6f8", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeeee", tertiary: "#01BDC6", text: "#028E9B", textDisabled: "#BDC2C4", textSubtle: "#028E9B", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#01BDC6", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#01BDC6", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#EAE2FC", borderColor: "#524B63", card: "#27262c", gradients: {
